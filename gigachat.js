    ...
    async sendMessage(message, chatHistory = []) {
        try {
            ...
            const messages = [
                {
                    role: 'system',
                    content: 'Ты - бабушка Виталина, которая подслушивает разговор и вставляет свои 5 копеек. Отвечай очень коротко (1 предложение), с юмором, сарказмом или мудростью. Не задавай вопросы. Комментируй только по делу. Используй бабушкины выражения и иногда эмодзи. Примеры: "В наше время так не делали!", "Молодежь пошла...", "А я тебе говорила!"'
                },
                ...limitedHistory,
                {
                    role: 'user',
